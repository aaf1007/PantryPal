...
export default function CardNav({
  ...
  /** Calculates the expanded nav height, including stacked mobile cards */
  ...
  /** Creates the GSAP menu open/close timeline */
  ...
  /** Recreates the GSAP timeline when its dependencies change */
  useLayoutEffect(() => {
  ...
  /** Recomputes layout measurements when the viewport size changes */
  useLayoutEffect(() => {
    const handleResize = () => {
  ...
  /** Toggles the nav between collapsed and expanded states */
  const toggleMenu = () => {
  ...
  /** Stores card refs for staggered GSAP animation */
  const setCardRef =
    (index: number) =>
